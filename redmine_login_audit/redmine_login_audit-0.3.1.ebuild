...
DESCRIPTION=" Redmine plugin to log successful login attempts in Redmine."
HOMEPAGE="http://martin-denizet.com"
# Tag v0.2.4
SRC_URI=" 	https://github.com/martin-denizet/redmine_login_audit/archive/master.zip -> ${P}.zip"
...
all_ruby_install() {
	dodoc README.md
	rm README.md CHANGELOG.md Gemfile || die
