...
DESCRIPTION="Redmine issue completion plugin helps you to fill some fields on issue close event."
HOMEPAGE="http://ashpak.ru"
#SRC_URI="https://github.com/insspb/redmine_issue_completion/archive/master.zip -> ${P}.zip"
SRC_URI="https://api.github.com/repos/insspb/${PN}/tarball -> ${P}.tar.gz"
